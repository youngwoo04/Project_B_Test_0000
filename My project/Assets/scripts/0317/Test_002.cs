...
public class Test_002 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        int n1 = 8;                 //정수 n1 선언 후 값 8 을 입력
        int n2 = 9;                 //정수 n2 선언 후 값 9 를 입력
        int answer2;                //정수 answer2 선언 
        answer2 = n1 + n2;          //정수 answer2에 n1과 n2 더한 값을 입력
        Debug.Log(answer2);         //answer2룰 Debug.Log에 출력 시킨다.   

        int answer3 = 10;           //정수 answer3 선언 후 값 10을 입력
        answer3 += 5;               //정수 answer3에 +5 값을 추가 (asnwer3 = answer3 + 5)
        Debug.Log(answer3);         //answer3를 Debg.Log에 출력 시킨다.
        answer3++;                  //정수 amswer3에 +1 값을 추가
        ...
        Debug.Log(message);             //message 값을 Debug.Log에 출력시킨다.
    }
